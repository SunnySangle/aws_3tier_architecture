...
![Three-Tier Architecture](http://web-server-elb-637181314.ap-south-1.elb.amazonaws.com/#/db)
...
```bash
git clone https://github.com/SunnySangle/aws_3tier_architecture.git
```
